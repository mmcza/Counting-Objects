...
def detect(img_path: str) -> Dict[str, int]:
    ...
    def search_contours(mask, col):
        ...
        for contour in contours:
            ...
            if col == (0, 0, 255) and area > 100:
                ...
                cv2.drawContours(resized_img, [contour], -1, col, 2)
                contour_number = contour_number+1
            elif col == (0, 255, 0)and area > 125: #tu było 125, przy zmianie na 100 jest do bani
                cv2.drawContours(resized_img, [contour], -1, col, 2)
                contour_number = contour_number+1
    ...
    yellow_lower = np.array([18, 180, 60]) #tu po lewej było 18, 15 to samo, 20 do bani, prawe było 120 110 to samo 130 do bani, 100 to samo, 60 to samo
    yellow_upper = np.array([28, 255, 255]) #tu po lewej było 30, lewe 25 do bani, obniżenie prawego jest do bani, środek niższy niż 255 to tragedia !!!! sprawdzić lewe 26
    ...
    purple_upper2 = np.array([7, 100, 70]) #tu lewe było 6 przy 7 tyle samo, prawe było na 30 przy 40 to samo przy 50 to samo 70 to samo
    ...
    yellow = search_contours(yellow_mask,(0, 255, 255))
    green = search_contours(green_mask,(0, 255, 0))
    purple = search_contours(purple_mask3,(128, 0, 128))
    red = search_contours(red_mask3, (0, 0, 255))
